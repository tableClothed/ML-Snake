...
def collision_with_boundaries(snake_head):
    if (snake_head[0]>=500 or snake_head[0]<0
            or snake_head[1]<0 or snake_head[1]>=500):
        return 1
    else:
        return 0
...
def is_direction_blocked(snake_position, current_direction_cevtor):
    next_step = snake_position[0]+current_direction_cevtor
    snake_head = snake_position[0]
    if collision_with_boundaries(snake_head) == 1 or collision_with_self(snake_position):
        return 1
    else:
        return 0
...
def play_game(snake_head, snake_position, apple_position, button_direction, apple, score):
    ...
    while crashed is not True:
        ...
        snake_position, apple_position, score = generate_snake(snake_head,
